...
// isPublicIP is the SSRF allowlist — delegated to the shared netguard guard so this public prober,
// tlsscan, and the L2 send_request primitive all screen with identical rules and can never drift apart.
