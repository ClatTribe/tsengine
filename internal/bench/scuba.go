...
func SCuBACatalog() []SCuBAPolicy {
	return []SCuBAPolicy{
		...
		{ID: "MS.AAD.5.3v1", Product: "m365/entra", Requirement: "An admin consent workflow SHALL be configured for applications.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "MS.AAD.6.1v1", Product: "m365/entra", Requirement: "User passwords SHALL NOT expire.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "MS.AAD.7.2v1", Product: "m365/entra", Requirement: "Privileged users SHALL be provisioned with finer-grained roles instead of Global Administrator.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "MS.AAD.7.8v1", Product: "m365/entra", Requirement: "User activation of the Global Administrator role SHALL trigger an alert.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "MS.TEAMS.1.1v1", Product: "m365/teams", Requirement: "External meeting participants SHOULD NOT be enabled to request control of shared desktops or windows.", Shall: false, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "MS.TEAMS.1.3v1", Product: "m365/teams", Requirement: "Anonymous users and dial-in callers SHOULD NOT be admitted automatically.", Shall: false, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "MS.TEAMS.1.5v1", Product: "m365/teams", Requirement: "Dial-in users SHOULD NOT be enabled to bypass the lobby.", Shall: false, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "MS.TEAMS.4.1v1", Product: "m365/teams", Requirement: "Teams email integration SHALL be disabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.COMMONCONTROLS.1.4v1", Product: "gws/common", Requirement: "The Google 2-Step Verification (2SV) new user enrollment period SHALL be set to at least one day and at most one week.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.COMMONCONTROLS.1.5v1", Product: "gws/common", Requirement: "Allow users to trust the device SHALL be disabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.COMMONCONTROLS.4.1v1", Product: "gws/common", Requirement: "Users SHALL be forced to re-authenticate after an established 12-hour GWS login session has expired.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.COMMONCONTROLS.5.4v1", Product: "gws/common", Requirement: "Password policy SHALL be enforced at next sign-in.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.COMMONCONTROLS.5.5v1", Product: "gws/common", Requirement: "User passwords SHALL NOT be reused.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.COMMONCONTROLS.5.6v1", Product: "gws/common", Requirement: "User passwords SHALL NOT expire.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.COMMONCONTROLS.6.1v1", Product: "gws/common", Requirement: "All administrative accounts SHALL be provisioned as cloud-only accounts separate from an agency's authoritative on-premises or other federated iden...", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.COMMONCONTROLS.10.2v1", Product: "gws/common", Requirement: "Agencies SHALL NOT allow users to grant consent for access to low-risk scopes.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.COMMONCONTROLS.10.3v1", Product: "gws/common", Requirement: "Agencies SHALL NOT trust unconfigured internal applications.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.COMMONCONTROLS.12.1v1", Product: "gws/common", Requirement: "Google Takeout services SHALL be disabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.DRIVEDOCS.1.3v1", Product: "gws/drive", Requirement: "Warnings SHALL be enabled when a user is attempting to share with someone in a non-allowlisted domain.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.DRIVEDOCS.1.4v1", Product: "gws/drive", Requirement: "If sharing outside of the organization, agencies SHOULD disable sharing of files with individuals who are not using a Google account.", Shall: false, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.DRIVEDOCS.1.7v1", Product: "gws/drive", Requirement: "Users SHOULD NOT be allowed to upload or move content to shared drives owned by another organization.", Shall: false, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.DRIVEDOCS.1.9v1", Product: "gws/drive", Requirement: "Out-of-Domain file-level warnings SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.DRIVEDOCS.3.1v1", Product: "gws/drive", Requirement: "Agencies SHALL enable the security update for Google Drive files.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.DRIVEDOCS.5.2v1", Product: "gws/drive", Requirement: "Monitoring for potential ransomware corruption SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.GMAIL.5.1v1", Product: "gws/gmail", Requirement: "\"Protect against encrypted attachments from untrusted senders\" SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.GMAIL.5.2v1", Product: "gws/gmail", Requirement: "\"Protect against attachments with scripts from untrusted senders\" SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.GMAIL.5.3v1", Product: "gws/gmail", Requirement: "\"Protect against anomalous attachment types in emails\" SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.GMAIL.5.4v1", Product: "gws/gmail", Requirement: "Google SHOULD be allowed to automatically apply future recommended settings for attachments.", Shall: false, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.GMAIL.6.1v1", Product: "gws/gmail", Requirement: "\"Identify links behind shortened URLs\" SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.GMAIL.6.2v1", Product: "gws/gmail", Requirement: "\"Scan linked images\" SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		{ID: "GWS.GMAIL.6.3v1", Product: "gws/gmail", Requirement: "\"Show warning prompt for any click on links to untrusted domains\" SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.GMAIL.7.6v1", Product: "gws/gmail", Requirement: "Emails flagged by SCuBA policies GWS.GMAIL.7.1 through GWS.GMAIL.7.5 SHALL NOT be kept in inbox.", Shall: true, Scope: ScopeDetectable, Rules: nil},
		...
		{ID: "GWS.CALENDAR.2.1v1", Product: "gws/calendar", Requirement: "External invitations warnings SHALL be enabled to prompt users before sending invitations.", Shall: true, Scope: ScopeDetectable, Rules: nil},
