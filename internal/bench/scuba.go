...
func SCuBACatalog() []SCuBAPolicy {
	return []SCuBAPolicy{
		...
		{ID: "MS.AAD.2.2v1", Product: "m365/entra", Requirement: "A notification SHOULD be sent to the administrator when high-risk users are detected.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::risky-user-notification-off"}},
		...
		{ID: "MS.AAD.3.1v1", Product: "m365/entra", Requirement: "Phishing-resistant MFA SHALL be enforced for all users.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::phishing-resistant-mfa-not-enforced", "~sspm::m365::weak-mfa-methods-enabled"}},
		...
		{ID: "MS.AAD.3.3v2", Product: "m365/entra", Requirement: "If Microsoft Authenticator is enabled, it SHALL be configured to show login context information.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::authenticator-context-disabled"}},
		{ID: "MS.AAD.3.4v1", Product: "m365/entra", Requirement: "The Authentication Methods Manage Migration feature SHALL be set to Migration Complete.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::auth-methods-migration-incomplete"}},
		...
		{ID: "MS.AAD.3.6v1", Product: "m365/entra", Requirement: "Phishing-resistant MFA SHALL be required for highly privileged roles.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::phishing-resistant-mfa-not-enforced", "~operate::admin-without-mfa"}},
		{ID: "MS.AAD.3.7v1", Product: "m365/entra", Requirement: "Managed devices SHOULD be required for authentication.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::managed-device-not-required"}},
		{ID: "MS.AAD.3.8v1", Product: "m365/entra", Requirement: "Managed Devices SHOULD be required to register MFA.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::managed-device-not-required"}},
		{ID: "MS.AAD.3.9v1", Product: "m365/entra", Requirement: "Device code authentication SHOULD be blocked.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::device-code-auth-allowed"}},
		{ID: "MS.AAD.4.1v1", Product: "m365/entra", Requirement: "Security logs SHALL be sent to the agency's security operations center for monitoring.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::security-logs-not-exported"}},
		...
		{ID: "MS.AAD.5.5v1", Product: "m365/entra", Requirement: "Application Password Addition SHOULD be blocked.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::app-credential-lifetime"}},
		{ID: "MS.AAD.5.6v1", Product: "m365/entra", Requirement: "Application password lifetime SHOULD be restricted to 180 days or less.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::app-credential-lifetime"}},
		{ID: "MS.AAD.5.7v1", Product: "m365/entra", Requirement: "Application certificate lifetime SHOULD be restricted to 365 days or less.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::app-credential-lifetime"}},
		...
		{ID: "MS.AAD.7.3v1", Product: "m365/entra", Requirement: "Privileged users SHALL be provisioned cloud-only accounts separate from an on-premises directory or other federated identity providers.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::privileged-accounts-not-cloud-only"}},
		...
		{ID: "MS.AAD.7.7v1", Product: "m365/entra", Requirement: "Eligible and active highly privileged role assignments SHALL trigger an alert.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::privileged-assignment-no-alert"}},
		...
		{ID: "MS.AAD.7.9v1", Product: "m365/entra", Requirement: "User activation of other highly privileged roles SHOULD trigger an alert.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::other-privileged-activation-no-alert"}},
		{ID: "MS.AAD.8.1v1", Product: "m365/entra", Requirement: "Guest users SHOULD have limited or restricted access to Microsoft Entra ID directory objects.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::guest-access-unrestricted"}},
		{ID: "MS.AAD.8.2v1", Product: "m365/entra", Requirement: "Only users with the Guest Inviter role SHOULD be able to invite guest users.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::guest-access-unrestricted"}},
		{ID: "MS.AAD.8.3v1", Product: "m365/entra", Requirement: "Guest invites SHOULD only be allowed to specific external domains that have been authorized by the agency for legitimate business purposes.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::guest-access-unrestricted"}},
		{ID: "MS.AAD.9.1v1", Product: "m365/entra", Requirement: "Risky AI agents SHALL be blocked.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::risky-ai-agents-not-blocked"}},
		...
		{ID: "MS.EXO.5.1v1", Product: "m365/exchange", Requirement: "SMTP AUTH SHALL be disabled.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::smtp-auth-enabled"}},
		{ID: "MS.EXO.6.1v1", Product: "m365/exchange", Requirement: "Contact folders SHALL NOT be shared with all domains.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::contact-folders-shared-all-domains"}},
		...
		{ID: "MS.SHAREPOINT.3.2v1", Product: "m365/sharepoint", Requirement: "The allowable file and folder permissions for links SHALL be set to view only.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::sharepoint-link-permissions-not-view-only"}},
		{ID: "MS.SHAREPOINT.3.3v2", Product: "m365/sharepoint", Requirement: "Reauthentication days for people who use a verification code SHALL be set to 30 days or less.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::sharepoint-verification-code-reauth-too-long"}},
		...
		{ID: "MS.TEAMS.1.4v1", Product: "m365/teams", Requirement: "Internal users SHOULD be admitted automatically.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::internal-users-not-auto-admitted"}},
		...
		{ID: "MS.TEAMS.1.6v1", Product: "m365/teams", Requirement: "Meeting recording SHOULD be disabled.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::meeting-recording-unrestricted"}},
		{ID: "MS.TEAMS.1.7v2", Product: "m365/teams", Requirement: "Record an event SHOULD NOT be set to Always record.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::meeting-recording-unrestricted"}},
		...
		{ID: "MS.TEAMS.2.2v2", Product: "m365/teams", Requirement: "Unmanaged users SHALL NOT be enabled to initiate contact with internal users.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::m365::unmanaged-users-can-initiate-contact"}},
		{ID: "MS.TEAMS.2.3v2", Product: "m365/teams", Requirement: "Internal users SHOULD NOT be enabled to initiate contact with unmanaged users.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::m365::unmanaged-user-contact-allowed"}},
		...
		{ID: "GWS.COMMONCONTROLS.1.1v1", Product: "gws/common", Requirement: "Phishing-Resistant MFA SHALL be required for all users.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::phishing-resistant-2sv-not-enforced", "~operate::user-without-mfa"}},
		...
		{ID: "GWS.COMMONCONTROLS.3.1v1", Product: "gws/common", Requirement: "Post-single sign-on (SSO) verification SHOULD be enabled for users signing in using the organization's SSO profile.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::post-sso-verification-off"}},
		{ID: "GWS.COMMONCONTROLS.3.2v1", Product: "gws/common", Requirement: "Post-SSO verification SHOULD be enabled for users signing in using other SSO profiles.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::post-sso-verification-off"}},
		...
		{ID: "GWS.COMMONCONTROLS.5.3v1", Product: "gws/common", Requirement: "User password length SHOULD be at least 16 characters.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::password-min-length-below-recommended"}},
		...
		{ID: "GWS.COMMONCONTROLS.7.1v1", Product: "gws/common", Requirement: "Account conflict management SHOULD be configured to replace conflicting unmanaged accounts with managed accounts.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::account-conflict-unmanaged"}},
		...
		{ID: "GWS.COMMONCONTROLS.8.3v1", Product: "gws/common", Requirement: "Ability to add recovery information SHOULD be disabled.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::recovery-info-allowed"}},
		...
		{ID: "GWS.COMMONCONTROLS.10.4v1", Product: "gws/common", Requirement: "Agencies SHALL NOT allow users to access unconfigured third-party applications.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::unconfigured-third-party-apps-allowed"}},
		...
		{ID: "GWS.COMMONCONTROLS.16.1v1", Product: "gws/common", Requirement: "Service status for Google services that do not have an individual control SHOULD be set to OFF for everyone.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::unassessed-services-enabled"}},
		{ID: "GWS.COMMONCONTROLS.16.2v1", Product: "gws/common", Requirement: "User access to Early Access applications SHOULD be disabled.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::unassessed-services-enabled"}},
		{ID: "GWS.COMMONCONTROLS.16.3v1", Product: "gws/common", Requirement: "Looker Studio Sharing outside org SHOULD be set to OFF.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::unassessed-services-enabled"}},
		{ID: "GWS.COMMONCONTROLS.16.4v1", Product: "gws/common", Requirement: "Pinpoint access to drive SHOULD be set to OFF.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::unassessed-services-enabled"}},
		...
		{ID: "GWS.DRIVEDOCS.1.10v1", Product: "gws/drive", Requirement: "If external sharing is not allowed, then forms owned by users within the organization SHOULD NOT be able to accept responses from anyone accessing...", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::forms-external-exchange"}},
		{ID: "GWS.DRIVEDOCS.1.11v1", Product: "gws/drive", Requirement: "If receiving external files is not allowed, then users in the organization SHOULD NOT be able to submit responses to forms from users or shared dri...", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::forms-external-exchange"}},
		{ID: "GWS.DRIVEDOCS.2.1v1", Product: "gws/drive", Requirement: "Agencies SHOULD NOT allow members with manager access to override shared Google Drive creation settings.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::shared-drive-creation-overridable"}},
		{ID: "GWS.DRIVEDOCS.2.2v1", Product: "gws/drive", Requirement: "Agencies SHALL allow users who are not members of a shared Google Drive to be added to files.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::non-members-cannot-be-added-to-files"}},
		...
		{ID: "GWS.DRIVEDOCS.4.1v1", Product: "gws/drive", Requirement: "Agencies SHOULD disable Google Drive SDK access.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::drive-sdk-enabled"}},
		...
		{ID: "GWS.GMAIL.1.1v1", Product: "gws/gmail", Requirement: "Mail delegation SHOULD be disabled.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::mail-delegation-enabled"}},
		...
		{ID: "GWS.GMAIL.5.5v1", Product: "gws/gmail", Requirement: "Emails flagged by SCuBA policies GWS.GMAIL.5.1 through GWS.GMAIL.5.3 SHALL NOT be kept in inbox.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::suspicious-mail-kept-in-inbox"}},
		...
		{ID: "GWS.GMAIL.6.4v1", Product: "gws/gmail", Requirement: "Google SHALL be allowed to automatically apply future recommended settings for links and external images.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::security-auto-apply-off"}},
		{ID: "GWS.GMAIL.7.1v1", Product: "gws/gmail", Requirement: "\"Protect against domain spoofing based on similar domain names\" SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::spoofing-protection-disabled"}},
		{ID: "GWS.GMAIL.7.2v1", Product: "gws/gmail", Requirement: "\"Protect against spoofing of employee names\" SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::spoofing-protection-disabled"}},
		...
		{ID: "GWS.GMAIL.7.5v1", Product: "gws/gmail", Requirement: "\"Protect your Groups from inbound emails spoofing your domain\" SHALL be enabled.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::spoofing-protection-disabled"}},
		...
		{ID: "GWS.GMAIL.7.7v1", Product: "gws/gmail", Requirement: "Google SHALL be allowed to automatically apply future recommended settings for spoofing and authentication.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::security-auto-apply-off"}},
		{ID: "GWS.GMAIL.8.1v1", Product: "gws/gmail", Requirement: "User email uploads SHALL be disabled to protect against unauthorized files being introduced into the secured environment.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::user-email-uploads-enabled"}},
		{ID: "GWS.GMAIL.9.1v1", Product: "gws/gmail", Requirement: "POP and IMAP access SHALL be disabled to protect sensitive agency or organization emails from being accessed through legacy applications or other t...", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::pop-imap-enabled"}},
		{ID: "GWS.GMAIL.10.1v1", Product: "gws/gmail", Requirement: "Google Workspace Sync SHOULD be disabled.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::workspace-sync-enabled"}},
		...
		{ID: "GWS.GMAIL.12.1v1", Product: "gws/gmail", Requirement: "The option to use a per-user outbound gateway that is a mail server other than the Google Workspace (GWS) mail servers SHALL be disabled.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::external-outbound-gateway"}},
		...
		{ID: "GWS.GMAIL.14.1v1", Product: "gws/gmail", Requirement: "An email allowlist SHOULD NOT be implemented.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::email-allowlist-implemented"}},
		{ID: "GWS.GMAIL.15.1v1", Product: "gws/gmail", Requirement: "Enhanced pre-delivery message scanning SHALL be enabled to prevent phishing.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::pre-delivery-scanning-off"}},
		{ID: "GWS.GMAIL.16.1v1", Product: "gws/gmail", Requirement: "Security sandbox SHOULD be enabled to provide additional email protections.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::security-sandbox-disabled"}},
		{ID: "GWS.GMAIL.17.1v1", Product: "gws/gmail", Requirement: "Comprehensive mail storage SHOULD be enabled to allow information traceability across applications.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::comprehensive-mail-storage-disabled"}},
		...
		{ID: "GWS.GMAIL.18.2v1", Product: "gws/gmail", Requirement: "Domains SHALL NOT be added to lists that bypass spam filters and hide warnings.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::spam-filter-bypass-list"}},
		{ID: "GWS.GMAIL.18.3v1", Product: "gws/gmail", Requirement: "\"Bypass spam filters\" and \"hide warnings for all messages from internal and external senders\" SHALL NOT be enabled.", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::spam-bypass-all-senders"}},
		...
		{ID: "GWS.CALENDAR.1.2v1", Product: "gws/calendar", Requirement: "External sharing options for secondary calendars SHALL be configured to \"Only free/busy information (hide event details).\"", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::secondary-calendar-external-sharing"}},
		...
		{ID: "GWS.CALENDAR.3.1v1", Product: "gws/calendar", Requirement: "Calendar Interop SHOULD be disabled.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::calendar-interop-enabled"}},
		{ID: "GWS.CALENDAR.3.2v1", Product: "gws/calendar", Requirement: "Microsoft 365 (Graph API) SHALL be used instead of basic authentication to establish connectivity between tenants or organizations in cases where C...", Shall: true, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::calendar-interop-basic-auth"}},
		{ID: "GWS.CALENDAR.4.1v1", Product: "gws/calendar", Requirement: "\"Appointment Schedule with Payments\" SHOULD be disabled.", Shall: false, Scope: ScopeDetectable, Rules: []string{"sspm::google_workspace::appointment-payments-enabled"}},
	}
}
