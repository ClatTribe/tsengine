...
const FINDING_FIELDS = [
  ...
  { icon: Fingerprint, t: "Evidence strength — incl. captured PoC", d: "Three tiers labelled inline: exploitation-proven (a reproducible proof you can replay was captured), tool-confirmed (verified / corroborated), and pattern-match — plus a CISA KEV flag when it's actively exploited in the wild. The strongest tier carries the proof." },
...
const QUALITY = [
  ...
  { icon: BadgeCheck, t: "Exploitation-proven, not pattern-only", d: "The strongest findings carry a captured, reproducible proof you can replay (exploitation-proven); others are labelled verified / corroborated vs pattern-match, and actively-exploited issues are flagged against CISA KEV — the accuracy signals a manual pentester earns by hand." },
