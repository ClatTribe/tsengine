    ...
    <>
      ...
      <section className="bg-surface">
        <div className="mx-auto max-w-3xl px-5 py-20 text-center">
          ...
          <Link href="/login" className="mt-7 inline-flex items-center gap-2 rounded-xl bg-accent px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-accent-hover">
