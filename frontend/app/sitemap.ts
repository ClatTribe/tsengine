...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPaths = ["", "/product", "/cross-detection", "/ai-security-engineer", "/ai-pentest", "/vapt", "/supply-chain", "/saas-posture", "/ci-cd", "/pricing", "/security", "/integrations", "/about", "/frameworks", "/scan", "/demo"];
