...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPaths = ["", "/product", "/cross-detection", "/ai-security-engineer", "/vapt", "/supply-chain", "/saas-posture", "/ci-cd", "/pricing", "/security", "/integrations", "/about", "/frameworks", "/scan", "/demo"];
