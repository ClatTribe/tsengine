...
export const ASSET_SURFACES: AssetSurface[] = [
  ...
  { key: "repository", label: "Source code", scans: "SAST, dependency CVEs (SCA) with reachability, supply-chain malware, end-of-life components, and hardcoded secrets", tools: ["semgrep", "trivy", "govulncheck", "malicious-packages", "eol", "gitleaks"] },
