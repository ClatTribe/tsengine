...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { t: "p", text: "You can see your externally-visible posture in 30 seconds with no account at all. Want to know what the full report looks like first? Here's a real, anonymized sample — every finding proven, with evidence, a fix, and the SOC 2 control it affects." },
