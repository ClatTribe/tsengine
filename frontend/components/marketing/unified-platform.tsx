...
// into one signed compliance posture. Grounded: the framework count is derived from FRAMEWORKS; no
...
const OUTCOMES = [
  ...
  },
  {
    ...
    body: `Every product's findings map to controls and roll into a single signed posture across all ${FRAMEWORK_COUNT} frameworks — so detection and audit-readiness move together.`,
  },
];
