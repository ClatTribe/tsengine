...
**DMARC is the best opener by a wide margin.** It's true on a large share of Series
A domains, it's trivially verifiable by the recipient in ten seconds, the impact
sentence needs no security background ("anyone can email your customers as you"),
and the fix is one DNS record. It earns a reply even when they don't buy.
